...
with tab_gp_drivers:
    ...
    df_drivers["gp_pct"] = (df_drivers["gp_std"] / (df_drivers["gross_sales"] - df_drivers["cogs"]) * 100).round(1)
    ...
    st.caption("💡 **Price Impact** = Precio del cliente vs promedio. **Cost Impact** = COGS del cliente vs promedio.")
    ...
    df_drivers_sku["gp_pct"] = (df_drivers_sku["gp_std"] / (df_drivers_sku["gross_sales"] - df_drivers_sku["cogs"]) * 100).round(1)
