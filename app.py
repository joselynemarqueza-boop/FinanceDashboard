...
def load_and_calculate():
    """Load data and calculate P&L by client"""
    ...
    # ========================================================================
    # 1. Process Commercial Discounts (go into the price)
    # ========================================================================
    commercial_discounts = gtn[gtn["account"].isin(COMMERCIAL_DISCOUNT_TYPES)].copy()
    
    # Discounts by specific category
    ...
    # "All" discounts apply to all categories
    ...
    # ========================================================================
    # 2. Process Structural GTN (after price)
    # ========================================================================
    ...
    # ========================================================================
    # 3. Process Tactical GTN (monthly promotions)
    # ========================================================================
    tactical_gtn = gtn[
        (gtn["month"] != "Annual") &
    ...
    # 4. Merge all data
    # ========================================================================
    # Keep only necessary columns from pricing to avoid duplicates
    pricing_keep = pricing[["sku", "rrp_gbp", "cogs_per_unit_gbp"]].copy()
    
    # Merge volume + pricing by SKU
    df = volume.merge(pricing_keep, on=["sku"], how="left")
    
    # Add commercial discounts
    ...
    # Price to client = RRP * (1 - commercial discounts)
...
def create_pl_table(df):
    ...
    # Calculate Structural and Tactical separately
...
col5.metric("COGS", fmt_currency(total_cogs), delta=f"{(total_cogs/total_nts*100):.1f}%")
...
# ============================================================================
st.divider()
st.caption(f"BeautyLab Financial Dashboard | Data up to {selected_year}")