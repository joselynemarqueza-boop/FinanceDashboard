...
def load_and_calculate():
    ...
    # Descuentos "All" (aplican a todas las categorías)
    ...
    # ========================================================================
    # 4. Fusionar todos los datos (SOLO POR SKU)
    # ========================================================================
    # volume + pricing por SKU
    df = volume.merge(pricing, on=["sku"], how="left")
    
    # Agregar descuentos comerciales
    ...
    # Precio al cliente = RRP * (1 - descuentos comerciales)
...
def create_pl_table(df):
    """Genera la tabla P&L por cliente"""
